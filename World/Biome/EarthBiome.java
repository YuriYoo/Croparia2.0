...
public class EarthBiome {
	...
	static class BiomeGenearthbiome extends Biome {
		public BiomeGenearthbiome(Biome.BiomeProperties mycustomProps) {
			...
			this.spawnableMonsterList.add(new SpawnListEntry(EntityCentaur.class, 4, 1, 2));
			this.spawnableMonsterList.add(new SpawnListEntry(EntityCentaurL.class, 2, 1, 2));
			this.spawnableMonsterList.add(new SpawnListEntry(EntityCentaurS.class, 3, 2, 4));
			this.spawnableMonsterList.add(new SpawnListEntry(EntityPoisonousFrog.class, 10, 2, 5));
		}

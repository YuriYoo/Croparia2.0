...
public class TileEntityRedstoneFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.redstone_furnace";
    }
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityRedstoneFurnace.class, new String[] {"Items"}));
    }
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockRedstoneFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }

...
public class BlockIcyPlant extends BlockBush 
{
    ...
    public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
    {
    	if(entityIn instanceof EntityPlayer)
    	{
    		...
    		if(this.name == "icy_plant")
    		{
    				if(player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() == ModItems.ELEMENTAL_WATER_FEET || player.getItemStackFromSlot(EntityEquipmentSlot.FEET).getItem() == ModItems.WATER_GEM_FEET)
    				{}
    				else
    					effect(entityIn);
    		}
    ...
    {
        return state.getBlock() == Blocks.ICE || state.getBlock() == Blocks.PACKED_ICE || state.getBlock() == ModBlocks.QUICK_ICE;
    }

...
public class BlockObsidianFurnace extends BlockContainer {
	...
	public BlockObsidianFurnace(boolean isBurning, String name) {
		super(Material.ROCK);
	...
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ModBlocks.OBSIDIAN_FURNACE);
	}
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		if (active) {
			worldIn.setBlockState(pos,
					ModBlocks.LIT_OBSIDIAN_FURNACE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
			worldIn.setBlockState(pos,
					ModBlocks.LIT_OBSIDIAN_FURNACE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
		} else {
			worldIn.setBlockState(pos,
					ModBlocks.OBSIDIAN_FURNACE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
			worldIn.setBlockState(pos,
					ModBlocks.OBSIDIAN_FURNACE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
		}
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		if (!(keepInventory)) {
			...
			if (tileentity instanceof TileEntityObsidianFurnace) {
				InventoryHelper.dropInventoryItems(worldIn, pos, (TileEntityObsidianFurnace) tileentity);
	...
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
		return new ItemStack(ModBlocks.OBSIDIAN_FURNACE);
	}

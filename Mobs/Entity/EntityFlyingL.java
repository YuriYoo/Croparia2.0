...
public class EntityFlyingL extends EntityMob
{
    ...
    public EntityFlyingL(World world)
    {
        super(world);
        this.setSize(1, 2);
    }
    ...
    protected void applyEntityAttributes()
    {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(400.0D * 1.5);
